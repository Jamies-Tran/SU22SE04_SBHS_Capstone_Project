...
public interface IUserRepository extends JpaRepository<UserEntity, Long> {
	...
	@Query(value = "select u from UserEntity u where u.citizenIdentificationString = :citizenIdentificationString")
	Optional<UserEntity> findUserByCitizenIdentificationString(
			@Param("citizenIdentificationString") String citizenIdentificationString);
}
