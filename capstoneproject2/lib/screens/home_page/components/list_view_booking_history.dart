...
class BookingHistoryComponent extends StatefulWidget {
  const BookingHistoryComponent({Key? key}) : super(key: key);

  @override
  State<BookingHistoryComponent> createState() => _BookingHistoryComponentState();
}

class _BookingHistoryComponentState extends State<BookingHistoryComponent> {
          ...
          if(snapshotData is List<BookingModel>) {
            ...
            return Column(
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      Column(
                        children: [
                          const Text("Homestay", style: TextStyle(
                            fontSize: 15,
                            fontFamily: 'OpenSans',
                            letterSpacing: 1.0,
                ...
                filterBookingList().isEmpty ? const Center(child: Text("Not thing here"),) :
                ListView.builder(
